...
\path|src/verify_D_Omega_2adic_chirality_phase.py| (interaction
fit, AIC + LOO model selection) and
\path|src/verify_D_Omega_discrete_laplacian_spectrum.py|
...
lattices at $N\!=\!600,700,800,1024$ finish; the
$\sin^{2}\!\theta\,v_{2}$ interaction model predicts
$D_{\Omega}(600)\!\approx\!0.49$,
$D_{\Omega}(700)\!\approx\!0.53$,
$D_{\Omega}(800)\!\approx\!0.38$,
$D_{\Omega}(1024)\!\approx\!0.13$ (deepest dip), giving an
explicit falsification chain for the lattice-resonance
mechanism.
...
\path|src/verify_D_Omega_2adic_resonance.py| and
\path|src/verify_D_Omega_discrete_laplacian_spectrum.py|.

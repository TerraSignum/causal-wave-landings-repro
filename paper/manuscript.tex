...
the discrete Laplacian eigenvalues $4\sin^{2}(\pi j/N)$ are
algebraic numbers in $\mathbb{Q}(\zeta_{2^{k}})$, generating
exact heat-kernel-cancellation identities that suppress the
diffusion-trace operator at post-flip phases where the
matter-side sine dominates. Reproducers

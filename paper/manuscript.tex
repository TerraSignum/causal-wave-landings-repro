...
(\url{https://github.com/[anonymized]/causal-wave-landings-repro})
...
+(\tfrac{4}{3}-\gamma^{2})\sin^{2}\theta,\qquad
...
\begin{proof}[Sketch.]
\textsc{(i)} The $L^{2}$ bound follows from the Stage 6f
...
preprint, 2026
(\url{https://github.com/[anonymized]/relational-carrier-manifest}).
...
preprint, 2026
(\url{https://github.com/[anonymized]/loop-class-closure-repro}).

\bibitem{Paper4}
S.~Bucciarelli,
\emph{Emergent Einstein dynamics from relational metric closure on finite correlation lattices},
preprint, 2026
(\url{https://github.com/[anonymized]/emergent-gr-closure-repro}).
...
preprint, 2026
(\url{https://github.com/[anonymized]/emergent-gr-schwarzschild-ppn-repro}).
...
preprint, 2026
(\url{https://github.com/[anonymized]/emergent-gr-anisotropic-source-dm-de-repro}).
...
preprint, 2026
(\url{https://github.com/[anonymized]/emergent-gr-h3c-witnesses-repro}).
...
(\url{https://github.com/[anonymized]/emergent-gr-atiyah-singer-chirality-repro}).
